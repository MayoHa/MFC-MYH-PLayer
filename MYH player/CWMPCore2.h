...
class CWMPCore2 : public COleDispatchDriver
{
public:
	CWMPCore2() {} // 调用 COleDispatchDriver 默认构造函数
	CWMPCore2(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWMPCore2(const CWMPCore2& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
