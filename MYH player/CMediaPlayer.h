...
class CMediaPlayer : public COleDispatchDriver
{
public:
	CMediaPlayer() {} // 调用 COleDispatchDriver 默认构造函数
	CMediaPlayer(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMediaPlayer(const CMediaPlayer& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
